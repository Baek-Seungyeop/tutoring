...
/*
	...
	2022년 4월 8일 튜터링 추가할 것(알아두면 좋은 것, 무조건 이런 실수하게 되어있다.) :
	double i = 1.0 / 3.0; 
	double j = 1.0f / 3.0f;
	float k = 1.0f / 3.0f;
...
/*
	...
	else if : 단독으로 쓸 수 없음에 유의, 위의 if문이 실행 안 되었을 때 추가적인 제어문을 하고 싶을 때 사용
	...
	switch는 위에서 아래로 가능 제어문이기에 특정 값을 수행 후 break;로 탈출 해줘야한다.
