...
/*
	...
	또한, 우리가 배우는 문법은 C이다. 나중에 C#, C++, java, python 등. 다른 언어를 2, 3, 4학년 때 듣게 될 것인데
	내가 지금 배우고 있는 C#, C++은 C의 개념만 확실히 알고있다면 달라진 문법만 이해하는 과정에서 쓰는데 부담이 없을 것이다.(그 만큼 C의 문법과 개념이 중요하다.)
*/
int main() {
